...
class Car {
    ...
    static distanceByFrame = 0.05; //determines how fast the car travels
    wheels = new Array();
    parts = new THREE.Group();
    static bodyMaterial = new THREE.MeshPhongMaterial({ color: 0xffff00 });

    constructor(scene, x, z, xLowerBoundary, xUpperBoundary, zLowerBoundary, zUpperBoundary, startTime) {
